...
const LINKS = [
  {
    ...
    items: [
      {
        title: "Địa chỉ",
        des: "Số 9, Đường Số 26, Phường Phước Long A, Tp Thủ Đức, Ho Chi Minh City, Vietnam",
      },
      {
        title: "Email",
        des: "dp.homeease@gmail.com",
      },
      {
        title: "Hotline",
        des: "+84 90 679 87 65",
    ...
    <FooterWrapper>
      <footer className="relative w-full footer">
        <img
          ...
          src="https://hismile.com.vn/wp-content/themes/nhakhoa/frontend/common/images/about_gallery3.png"
          alt=""
        />

        <div className="footer-wrapper mx-auto w-full px-0 lg:px-8 relative z-3 pt-40 sm-pt-16 ">
          <div className="container">
            <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
              <div className=" w-full lg:w-3/5">
                ...
                <h5 className="mb-6 mt-16 text-white">
                  HomeEase - Nền tảng kết nối việc làm Toàn Quốc. Qua bên thứ 3 là HOMEEASE, khách hàng sẽ được hưởng
                  những lợi ích vượt trội so với sự uy tín chất lượng đặt lên đầu!!!
                </h5>
              </div>
            ...
            <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row">
              <Typography variant="small" className="mb-4 text-center font-normal text-white  md:mb-0">
                &copy; {currentYear} <a href="/">HomeEase</a>
              </Typography>
              {/* <div className="flex gap-4  sm:justify-center">
                <Typography color="white" as="a" href="#" className="opacity-80 transition-opacity hover:opacity-100">
