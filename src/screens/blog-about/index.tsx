        ...
        <div className="w-full h-fit flex justify-center max-w-[1200px] mb-5 gap-[40px] mb-flex-col ">
          ...
          <div className="w-1/2 mb-w-full">
            ...
            <p>
              ...
              are an ideal partner for companies and sponsors seeking a stable source of capital. BlackRock TCP Capital
              Corp.’s investment advisor (the “Advisor”) is an indirect wholly-owned subsidiary of BlackRock, Inc.
              BlackRock TCP Capital Corp.’s investment activities benefit from the competitive advantages of our
              Advisor, including the deep skills and diverse experience of its investment professionals, its proprietary
              deal flow, and its consistent and rigorous investment process. BlackRock’s credit expertise, brand, and
              global scope, provide TCPC with access to greater resources to provide a complete solution to middle
              market companies.
            </p>
            ...
            <p>
              ...
              loans to 733 companies since 1999. BlackRock TCP Capital Corp.’s target investments are generally in
              ...
              invest in secondary-market investment opportunities. BlackRock TCP Capital Corp.’s focus is primarily on
