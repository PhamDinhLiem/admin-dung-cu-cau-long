...
import RegisterHomeownerScreen from "@/screens/register-homeowner";
...
export async function generateMetadata({ params }: any) {
  ...
  const pageTitle = "Chủ nhà cùng kết nối với HomeEase";
  const pageDes =
  ...
  const keywords = ["HomeEase", "Nền tảng kết nối việc làm toàn quốc", "Chủ nhà"];
