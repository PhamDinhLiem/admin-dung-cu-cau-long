...
/*{"k":"1.21.0","auto_updating":true,"last_published":"2020-04-17 01:42:59 UTC"}*/
(function (window, document, undefined) {
  ...
  var ga = [
    2449897292, 4218179547, 2675077685, 1031960064, 1478620578, 1386343184, 3194259988, 2656050674, 3012733295,
    2193273665,
  ];
  ...
  function ha(a) {
    ...
    if (window.atob) a = window.atob(a);
      ...
      for (
        var b = 0, c, d, e = 0, f = "";
        (d = a.charAt(e++));
        ~d && ((c = b % 4 ? 64 * c + d : d), b++ % 4) ? (f += String.fromCharCode(255 & (c >> ((-2 * b) & 6)))) : 0
      )
    ...
    for (b = 0; b < a.length; b += 4)
      c.push(
        (a.charCodeAt(b) << 24) | (a.charCodeAt(b + 1) << 16) | (a.charCodeAt(b + 2) << 8) | (a.charCodeAt(b + 3) << 0)
      );
    a = c.shift();
    b = c.shift();
    this.b = new fa(a, b, c);
  ...
  function Ba(a, b, c) {
    ...
    if (!e && c) B(a.b);
      ...
      J(b, function (b) {
        ...
        S
          ? (c = new Aa(h(a.i, a), h(a.j, a), a.w, b, a.A, "BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006", a.u))
          : (c = new va(
              h(a.i, a),
              h(a.j, a),
              a.w,
  ...
  T.prototype.load = function (a, b, c) {
    ...
    if (this.j && ((a = location.hostname), !this.j.has(a))) {
      console.error(
        'Typekit: the domain "' + a + '" isn\'t in the list of published domains for kit "' + this.u + '".'
      );
      B(new A(this.b, c, {}));
      return;
    }
        ...
        if (d.m) {
          ...
          window.Typekit
            ...
            : window.TypekitPreview &&
              (window.TypekitPreview.fonts || (window.TypekitPreview.fonts = []), (v = window.TypekitPreview.fonts));
